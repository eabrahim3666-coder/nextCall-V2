        ...
        <div className="min-h-screen bg-[#050505] grain">
            <nav className="bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-white/[0.06] px-6 py-3 flex justify-between items-center sticky top-0 z-50">
                ...
                <div className="flex items-center gap-4">
                    <Link href="/admin/chat" className="inline-flex items-center gap-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 px-3 py-1.5 text-xs font-medium hover:bg-indigo-500/20 transition-colors">
