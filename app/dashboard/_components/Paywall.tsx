        ...
        <div className="min-h-[80vh] flex items-center justify-center px-4">
            <div className="w-full max-w-4xl">
                <div className="text-center mb-10">
                    ...
                    <p className="text-sm text-[#A7ADBB] mt-3">Your AI is configured and ready. Choose a plan to bring it to life.</p>
                </div>

                <div className={`grid gap-6 ${allowTrial ? "md:grid-cols-3" : "md:grid-cols-2 max-w-3xl mx-auto"}`}>
                    {/* Free Trial */}
                    {allowTrial && (
                    <div className="relative p-8 rounded-2xl bg-black border border-white/5 text-center">
                        <div className="mb-5">
                            <h3 className="text-lg font-semibold text-white">Free Trial</h3>
                            <p className="text-xs text-[#A7ADBB] mt-1">Test the waters</p>
                        </div>

                        <div className="mb-6">
                            <div className="flex items-baseline justify-center gap-1">
                                <span className="text-4xl font-semibold text-white">$0</span>
                                <span className="text-sm text-[#A7ADBB]">/3 days</span>
                            </div>
                        ...
                        <div className="space-y-2.5 mb-8 text-left inline-block">
                            ...
                            {[
                                ...
                                <div key={i} className="flex items-start gap-2.5 opacity-50">
                                    <span className="text-[#A7ADBB] text-xs mt-0.5 flex-shrink-0">−</span>
                                    <span className="text-xs text-[#A7ADBB] line-through">{item}</span>
                                </div>
                            ))}
                        </div>
                        ...
                        <div>
                            <button
                                ...
                                className="w-full bg-black border border-white/5 text-white text-sm font-medium px-6 py-3 rounded-full hover:bg-white/[0.1] transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                            >
                    ...
                    <div className="relative p-8 rounded-2xl bg-black border border-white/5 text-center">
                        <div className="mb-5">
                            ...
                            <p className="text-xs text-[#A7ADBB] mt-1">For small businesses</p>
                        </div>
                        ...
                        <div className="space-y-2.5 mb-8 text-left inline-block">
                            {[
                                ...
                                <div key={i} className="flex items-start gap-2.5">
                                    <span className={`${i === 0 ? "text-[#ff4b00]" : "text-emerald-400"} text-xs mt-0.5 flex-shrink-0`}>+</span>
                                    <span className={`text-xs ${i === 0 ? "text-[#ff4b00] font-medium" : "text-neutral-300"}`}>{item}</span>
                                </div>
                            ))}
                        </div>
                    ...
                    {/* Premium Plan */}
                    <div className="relative p-8 rounded-2xl bg-black border border-[#ff4b00]/30 overflow-hidden text-center">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#ff4b00]/10 rounded-full blur-[50px] pointer-events-none" />
                        <div className="relative z-10">
                            <div className="flex items-center justify-center gap-3 mb-5">
                                <div>
                                    <h3 className="text-lg font-semibold text-white">Premium</h3>
                                    <p className="text-xs text-[#A7ADBB] mt-1">For growing teams</p>
                                </div>
                                <span className="text-[10px] font-medium uppercase tracking-wider text-[#ff4b00] bg-[#ff4b00]/10 border border-[#ff4b00]/20 px-3 py-1 rounded-full">Popular</span>
                            </div>
