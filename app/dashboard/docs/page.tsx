...
function Badge({ tier }: { tier: "trial" | "standard" | "premium" }) {
    const styles = {
        trial: "bg-neutral-500/10 text-[#A7ADBB] border-neutral-500/20",
        standard: "bg-[#ff4b00]/10 text-[#ff4b00] border-[#ff4b00]/20",
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div>
                ...
                <p className="mt-1 text-sm text-[#A7ADBB]">Everything you need to know about using nextCall effectively and safely.</p>
            </div>
            ...
            <div className="bg-black border border-white/5 rounded-2xl p-8">
                ...
                <p className="text-xs text-[#A7ADBB] mb-6">Every feature in nextCall, and which plan it comes with.</p>

                <Accordion type="single" collapsible className="w-full space-y-3">
                    <AccordionItem value="plan-trial" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                            <span className="flex items-center gap-3"><Badge tier="trial" /> Free Trial — $0 / 3 days, 50 minutes
                            </span>
                        </AccordionTrigger>
                        <AccordionContent className="text-xs text-[#A7ADBB] space-y-3 pb-4">
                            ...
                            <p className="text-[#A7ADBB] italic">Paid-only features (marked below) are locked during the trial. Upgrade any time from Settings → Billing.</p>
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="plan-standard" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                    ...
                    <AccordionItem value="plan-premium" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
            ...
            <div className="bg-black border border-white/5 rounded-2xl p-8">
                ...
                <p className="text-xs text-[#A7ADBB] mb-6">Follow these steps to get your AI receptionist live.</p>

                <Accordion type="single" collapsible className="w-full space-y-3">
                    <AccordionItem value="step-1" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                        ...
                        <AccordionContent className="text-xs text-[#A7ADBB] space-y-3 pb-4">
                            ...
                            <p className="text-[#A7ADBB] italic">Click Save Settings after every change. Your AI updates instantly.</p>
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="step-2" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                        ...
                        <AccordionContent className="text-xs text-[#A7ADBB] space-y-3 pb-4">
                            ...
                            <p className="text-[#A7ADBB] italic">Tip: The more specific you are in Exclusions and FAQs, the fewer mistakes the AI will make.</p>
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="step-3" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                        ...
                        <AccordionContent className="text-xs text-[#A7ADBB] space-y-3 pb-4">
                            ...
                            <ul className="list-disc list-inside space-y-1.5 ml-1">
                                <li><strong className="text-white">Forward Emergency Calls</strong> — When enabled, the AI will call your phone if the caller uses emergency keywords. <span className="text-[#A7ADBB]">(All plans)</span></li>
                            ...
                            <p className="text-[#A7ADBB] italic">Hot-lead notifications and missed-call SMS are Premium-only. Email follow-up, daily summary, appointment reminders, and auto review follow-up are included in Standard & Premium.</p>
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="step-4" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                        ...
                        <AccordionContent className="text-xs text-[#A7ADBB] space-y-3 pb-4">
                            ...
                            <ul className="list-disc list-inside space-y-1.5 ml-1">
                                <li><strong className="text-white">Get a New Number</strong> — Go to <strong className="text-white">Dashboard → Numbers</strong> and click &quot;Buy Number&quot;. We provision a local number in your area code instantly. <span className="text-[#A7ADBB]">Trial & Standard: 1 number. Premium: 3 numbers, plus extra numbers available on the Premium plan.</span></li>
                            ...
                            <p className="text-[#A7ADBB] italic">Warning: Do not cancel your old phone service until you confirm calls are flowing through nextCall.</p>
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="step-5" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                    ...
                    <AccordionItem value="step-6" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                        ...
                        <AccordionContent className="text-xs text-[#A7ADBB] space-y-3 pb-4">
                            ...
                            <p className="text-[#A7ADBB] italic">Make adjustments in Settings and re-test until everything sounds natural.</p>
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="step-7" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                        ...
                        <AccordionContent className="text-xs text-[#A7ADBB] space-y-3 pb-4">
                            ...
                            <p className="text-[#A7ADBB] italic">The review link used in the SMS is the Google review link configured for your account.</p>
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            </div>
            ...
            <div className="bg-black border border-white/5 rounded-2xl p-8">
                ...
                <p className="text-xs text-[#A7ADBB] mb-6">The full lifecycle of a call from start to finish.</p>

                <Accordion type="single" collapsible className="w-full space-y-3">
                    <AccordionItem value="how-1" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                    ...
                    <AccordionItem value="how-2" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                        ...
                        <AccordionContent className="text-xs text-[#A7ADBB] space-y-3 pb-4">
                            ...
                            <p className="text-[#A7ADBB] italic">Requires Google Account integration enabled in Settings → Integrations.</p>
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="how-3" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
            ...
            <div className="bg-black border border-white/5 rounded-2xl p-8">
                ...
                <p className="text-xs text-[#A7ADBB] mb-6">Connect nextCall with your existing tools.</p>

                <Accordion type="single" collapsible className="w-full space-y-3">
                    <AccordionItem value="int-1" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                            Google Calendar
                        </AccordionTrigger>
                        <AccordionContent className="text-xs text-[#A7ADBB] space-y-3 pb-4">
                            <p>When connected, the AI automatically creates calendar events for appointments booked over the phone. <span className="text-[#A7ADBB]">Included on all plans.</span></p>
                            <ul className="list-disc list-inside space-y-1.5 ml-1">
                    ...
                    <AccordionItem value="int-2" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
            ...
            <div className="bg-black border border-white/5 rounded-2xl p-8">
                ...
                <p className="text-xs text-[#A7ADBB] mb-6">How to register for texting — and why it&apos;s required.</p>

                <Accordion type="single" collapsible className="w-full space-y-3">
                    <AccordionItem value="sms-1" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                    ...
                    <AccordionItem value="sms-2" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                        ...
                        <AccordionContent className="text-xs text-[#A7ADBB] space-y-3 pb-4">
                            ...
                            <p className="text-[#A7ADBB] italic">Only send-for-business: you will never be asked for your Twilio credentials or account details.</p>
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="sms-3" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
            ...
            <div className="bg-black border border-white/5 rounded-2xl p-8">
                ...
                <p className="text-xs text-[#A7ADBB] mb-6">Guidelines for using nextCall responsibly.</p>

                <Accordion type="single" collapsible className="w-full space-y-3">
                    <AccordionItem value="rules-1" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                    ...
                    <AccordionItem value="rules-2" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                    ...
                    <AccordionItem value="rules-3" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                    ...
                    <AccordionItem value="rules-4" className="bg-black border border-white/5 rounded-xl px-5">
                        <AccordionTrigger className="text-sm font-medium text-white hover:text-[#ff4b00] py-4">
                        ...
                        <AccordionContent className="text-xs text-[#A7ADBB] space-y-3 pb-4">
                            <ul className="list-disc list-inside space-y-1.5 ml-1">
                                ...
                                <li>See our full Privacy Policy at <a href="/privacy" className="text-[#ff4b00] hover:text-[#ff4b00]">/privacy</a>.</li>
                            </ul>
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            ...
            <div className="bg-rose-500/[0.03] border border-rose-500/20 rounded-2xl p-8">
                ...
                <p className="text-xs text-[#A7ADBB] mb-6">Please read these carefully before deploying nextCall.</p>
